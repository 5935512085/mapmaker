...
class _BlockDropState extends State<BlockDrop> {
  ...
  List<BoolList>QRCheck = [BoolList(Acpt: "QR1",x: false),BoolList(Acpt: "QR2",x: false),BoolList(Acpt: "QR3",x: false),
    BoolList(Acpt: "QR4",x: false),BoolList(Acpt: "QR5",x: false),BoolList(Acpt: "QR6",x: false),BoolList(Acpt: "QR7",x: false)];
  List<BoolList>GroundCheck = [BoolList(Acpt: "AG1",x: false),BoolList(Acpt: "AG2",x: false),BoolList(Acpt: "AG3",x: false),
    BoolList(Acpt: "AG4",x: false)];
  List<BoolList>BuildingCheck = [BoolList(Acpt: "BD1",x: false),BoolList(Acpt: "BD2",x: false),BoolList(Acpt: "BD3",x: false),
    BoolList(Acpt: "BD4",x: false),BoolList(Acpt: "BD5",x: false)];
  //////// Road ///////////////
...
//  bool Acpt2H =false,Acpt6H =false,Acpt8H =false,Acpt9H =false;
  ...
  PreventError(){
      for(int i =0; i<=QRCheck.length;i++){
        setState(() {
          QRCheck.elementAt(i).x == false;
        });
      }
      for(int i =0; i<=GroundCheck.length;i++){
        setState(() {
          GroundCheck.elementAt(i).x == false;
        });
      }
  }
  ...
  CheckFill(String Img_name){
    if (Img_name =='AG1'){
      return ImgButt(0, 0);
    }
  }
  ClickFillButt(int x, int y ,bool active, String img){
    if(active==true){
      return  CheckFill(img);
    }else if (active==false){
      if(x==null && y==null){
        return SizedBox(child: Container(decoration: BoXBorder(),child:Icon(Icons.add,color: Colors.red,size: 10,)),height: widget.SizeH,width: widget.SizeW,);
      }
      return new SizedBox(width: widget.SizeW,height: widget.SizeH,
        child: Transform.rotate(
          angle: _angleButt,
...
///////////// oneblog //////////////////////////////////////////////////////////////////////
            return GroundCheck.elementAt(0).x ? ClickFillButt(0, 0, widget.auto_set, widget.auto_in)
//                : Acpt_Agr? ImgButt(0, 1) : Acpt_Agy? ImgButt(0, 2) : Acpt_Aor? ImgButt(0, 3)
...
//                :Acpt_Rdil? ImgButt(5, 12):Acpt_Rdir? ImgButt(5, 13):Acpt_Rdit? ImgButt(5, 14) :AcptMulti? ImgButt(5, 15)
                ...
                : data.isEmpty ? ClickFillButt(in1, in2, widget.auto_set, widget.auto_in)
                : Opacity(opacity: 0.7,
          ...
          onAccept:(data){
            ...
            if (data =='AG1'){
              setState(() {
                ...
                in1 = 0;
                in2 = 0;
                GroundCheck.elementAt(0).x == true;
              });
            }
//            else if (data == 'Agr'){
//              setState(() {
