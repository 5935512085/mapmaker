...
import 'package:mapmaker/SubFucntion/Alllist.dart';
...
class Canvas2D1 extends StatefulWidget {

  @override
  _Canvas2D1State createState() => _Canvas2D1State();
...
class _Canvas2D1State extends State<Canvas2D1> {
          ...
          child: new Column(
            ...
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  Text("  Reference Area 300m X 300m ",style:TextStyle(color: Colors.black87,fontSize: 16)),
                ],
              ),
              Divider(),
              new Row(
                ...
                children: <Widget>[
                  ...
                  Column(children: <Widget>[
                    ...
                    BlockDropWay(widget.SizeHH,widget.SizeHW),BlockDropWay(widget.SizeHH,widget.SizeHW)
                  ],)
                ],
              ),
              new Row(
             ...
             new Row(
               ...
               BlockDropWay(widget.SizeCH, widget.SizeCW),BlockDropWay(widget.SizeWH, widget.SizeWW),BlockDropWay(widget.SizeWH, widget.SizeWW),
               BlockDropWay(widget.SizeCH, widget.SizeCW),BlockDropWay(widget.SizeWH, widget.SizeWW),BlockDropWay(widget.SizeWH, widget.SizeWW),
               BlockDropWay(widget.SizeCH, widget.SizeCW),BlockDropWay(widget.SizeWH, widget.SizeWW),BlockDropWay(widget.SizeWH, widget.SizeWW),
               BlockDropWay(widget.SizeCH, widget.SizeCW),BlockDropWay(widget.SizeWH, widget.SizeWW),BlockDropWay(widget.SizeWH, widget.SizeWW),
               BlockDropWay(widget.SizeCH, widget.SizeCW),BlockDropWay(widget.SizeWH, widget.SizeWW),BlockDropWay(widget.SizeWH, widget.SizeWW),
             ...
             Divider(),
              new IconList2(sizeH:30.0,sizeW: 30.0,),
             ...
             Row(
              ...
              Spacer(),
              Container(
                height: 30.0 ,width: 190.0, decoration: Txborder(),
              ...
              Spacer(),
              Container(height: 30.0 ,width: 100.0, decoration: Txborder(),
